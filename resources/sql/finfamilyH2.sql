...
insert into sukusettings (settingtype,settingindex,settingname,settingvalue) values ('order',5,'notice','DEAT');
insert into sukusettings (settingtype,settingindex,settingname,settingvalue) values ('order',6,'notice','BURI');
insert into sukusettings (settingtype,settingindex,settingname,settingvalue) values ('order',7,'notice','RESI');
